...
![GIF3](https://github.com/Guter-Mann//Xlams/blob/main/GIFs/KillQuip/3.gif?raw=true)

Скрипт в выделенной области ищет сообщения в красной рамке, которые появляются тогда,
когда игрок совершает убийство (или помогает в убийстве).

Если условие выполнено, то в корневой директории игры создаётся конфигурационный файл
`quip.cfg` с такой командой:
